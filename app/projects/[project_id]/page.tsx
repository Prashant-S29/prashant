        ...
        <div>
          ...
          {data.tag === 'Design' ? (
            ...
            <div className="flex items-center gap-5">
              ...
              {data.sourceCodeLink && (
                <Link href={data.sourceCodeLink} className="flex items-center gap-2 text-[13px] font-medium text-[#858585]">
          ...
          <div
            className="mt-5 flex h-[280px] w-full items-center justify-center rounded-lg border border-[#242424] bg-[#1c1c1c] bg-cover bg-no-repeat max-[400px]:h-full sm:h-[350px]"
